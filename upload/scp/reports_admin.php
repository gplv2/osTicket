...
$update="UPDATE ost_reports SET 3d=$threeD,graphWidth=$graphWidth,graphHeight=$graphHeight,resolution='$resolution',viewable='$viewable' WHERE 1";
$result = mysql_query($update) or die( "An error has occured: " .mysql_error (). ":" .mysql_errno ());  
//echo $update;

} // Close "if submitted" 

$query = "SELECT 3d,graphWidth,graphHeight,resolution,viewable from ost_reports LIMIT 1";
